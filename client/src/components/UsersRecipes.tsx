          ...
          <div className="px-3 py-2">
            ...
            <div className="flex justify-between pt-2">
              <div className="flex justify-end w-full">
                ...
                <button
                  onClick={() =>
                    handleDelete(recipe.id, recipe.imageUrl!)
                  }
                  className="flex justify-center py-2 mr-5 bg-red-100 rounded-lg cursor-pointer w-11 hover:bg-red-500"
                >
                  <FaTrash className="w-5 h-5 text-black" />
                </button>
              </div>
            </div>
          </div>
